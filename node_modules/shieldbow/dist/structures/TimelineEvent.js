...
class TimelineEventFactory {
    ...
    static create(client, data) {
        switch (data.type) {
            ...
            case 'ITEM_PURCHASED':
                return new ItemPurchasedEvent(client, data);
            case 'ITEM_UNDO':
                return new ItemUndoEvent(client, data);
            case 'WARD_PLACED':
                return new WardPlacedEvent(data);
            case 'ITEM_DESTROYED':
                return new ItemDestroyedEvent(client, data);
            case 'LEVEL_UP':
            ...
            case 'ITEM_SOLD':
                return new ItemSoldEvent(client, data);
