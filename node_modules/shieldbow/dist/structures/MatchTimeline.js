...
const TimelineFrame_1 = require("./TimelineFrame");
/**
...
class MatchTimeline {
    ...
    constructor(client, data) {
         ...
         */
        Object.defineProperty(this, "participantIds", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.frames = data.info.frames.map((frame) => new TimelineFrame_1.TimelineFrame(client, frame));
    }
}
