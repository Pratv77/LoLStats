...
class CurrentGame {
    ...
    constructor(client, data) {
        ...
        this.teams.set('blue', new CurrentGameTeam_1.CurrentGameTeam(client, data.bannedChampions.filter((c) => c.teamId === 100), data.participants.filter((p) => p.teamId === 100)));
        this.teams.set('red', new CurrentGameTeam_1.CurrentGameTeam(client, data.bannedChampions.filter((c) => c.teamId === 200), data.participants.filter((p) => p.teamId === 200)));
    }
    /**
