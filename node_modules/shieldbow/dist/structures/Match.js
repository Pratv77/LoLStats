...
class Match {
    ...
    constructor(client, data) {
        ...
        this.teams.set('blue', new Team_1.Team(client, blueTeamData, blueTeamParticipants));
        this.teams.set('red', new Team_1.Team(client, redTeamData, redTeamParticipants));
    }
    /**
